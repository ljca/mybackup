...
+ [Ajax，Async.. JavaScript And XML：异步JavaScript和XML可扩展语言](develop/others/ajax.md)
+ [Android 笔记：](develop/others/android/android.md)
+ [在 Linux 命令行上管理 Android 项目](develop/others/android/android_apk.md)
+ [adb：Android调试桥](develop/others/android/android_tools.md)
+ [compier_android](develop/others/android/compier_android.md)
+ [C# 笔记](develop/others/c#.md)
+ [CSS：层叠样式表](develop/others/css.md)
+ [Access学习笔记](develop/others/db/access.md)
+ [Db2安装配置笔记](develop/others/db/db2.md)
+ [MySQL[^sql]笔记](develop/others/db/mysql.md)
+ [★ Oracle的基本操作 DML:CUID](develop/others/db/oracle.md)
+ [sqlite](develop/others/db/sqlite.md)
+ [SQLServer 笔记：](develop/others/db/sqlserver.md)
+ [charpter1](develop/others/docbook.md)
+ [gtk](develop/others/gtk.md)
+ [HTML](develop/others/html.md)
+ [Java](develop/others/java/java.md)
+ [Java第一课：Java开发环境](develop/others/java/Java第一课：Java开发环境.md)
+ [Java第二课](develop/others/java/Java第二课.md)
+ [Jsp & Servlet：](develop/others/java/jsp_servlet.md)
+ [Structs Sprint Hibernate：Java Web 的三大框架](develop/others/java/jsp_ssh.md)
+ [调整java图形程序默认字体](develop/others/java/调整java图形程序默认字体.md)
+ [JavaScript[^js]：在浏览器客户端执行的脚本](develop/others/js.md)
+ [Markdown 笔记](develop/others/markdown.md)
+ [mdwiki :](develop/others/mdwiki.md)
+ [ncursers：控制台下的图形界面](develop/others/ncurses.md)
+ [PHP笔记：PHP 中文手册在[这里][php-man-zh].](develop/others/php.md)
+ [Python[^version] 学习笔记](develop/others/python2.md)
+ [Python 3 笔记：基础语法](develop/others/python3.md)
+ [Qt开发环境搭建小记](develop/others/qt.md)
+ [Markdown List: ](files.md)
...
+ [Linux 图片工具](Linux笔记/app/pic_utils.md)
...
+ [Linux上gtk程序的最近打开](Linux笔记/Arch/Linux上gtk程序的最近打开.md)
+ [Linux上较轻量级浏览器Opera的简要配置](Linux笔记/Arch/Linux上较轻量级浏览器Opera的简要配置.md)
+ [Linux可执行文件预编译的和自己从源代码中编译安装的有什么区别](Linux笔记/Arch/Linux可执行文件预编译的和自己从源代码中编译安装的有什么区别.md)
+ [Linux声卡独占问题](Linux笔记/Arch/Linux声卡独占问题.md)
+ [Linux平台下的中国象棋游戏gmchess](Linux笔记/Arch/Linux平台下的中国象棋游戏gmchess.md)
...
+ [Old Ubuntu Releases](Linux笔记/Arch/OldUbuntuReleases.md)
+ [pacman：Arch Linux 软件包管理器](Linux笔记/Arch/pacman.md)
+ [pidgin-lwqq & Smart QQ 已经快要玩完，都散了吧](Linux笔记/Arch/pidgin-lwqq_SmartQQ已经快要玩完，都散了吧.md)
+ [rar一次解压多个密码相同的rar压缩包](Linux笔记/Arch/rar一次解压多个密码相同的rar压缩包.md)
+ [Rhythmcat在Arch Linux的编译安装](Linux笔记/Arch/Rhythmcat在ArchLinux的编译安装.md)
...
+ [为什么显示管理器服务开始运行了之后就不可以停止？](Linux笔记/Arch/为什么显示管理器服务开始运行了之后就不可以停止.md)
...
+ [当我在terminal上输入汉字时，输入的汉字在terminal上却直接变成了unicode字符的编码](Linux笔记/Arch/当我在terminal上输入汉字时，输入的汉字在terminal上却直接变成了unicode字符的编码.md)
+ [当我注销掉xfce4-session后再次启动xfce-session时，被lxdm拒绝.....](Linux笔记/Arch/当我注销掉xfce4-session后再次启动xfce-session时，被lxdm拒绝......md)
+ [当我的Arch Linux自动挂起之后被重新唤醒时，Thunar等Gtk程序的菜单（右键上下文和菜单栏）等变成了英文](Linux笔记/Arch/当我的ArchLinux自动挂起之后被重新唤醒时，Thunar等Gtk程序的菜单（右键上下文和菜单栏）等变成了英文.md)
+ [怎样在 Arch Linux 构建一个简单的软件包？](Linux笔记/Arch/怎样在ArchLinux构建一个简单的软件包？.md)
+ [用的好好的Arch Linux突然放不出了声音](Linux笔记/Arch/用的好好的ArchLinux突然放不出了声音.md)
+ [让Arch Linux“滚回”到以前的版本](Linux笔记/Arch/让ArchLinux“滚回”到以前的版本.md)
+ [让显示管理器在其它的tty启动](Linux笔记/Arch/让显示管理器在其它的tty启动.md)
+ [调整本地qt4应用程序界面字体风格的一种方式](Linux笔记/Arch/调整本地qt4应用程序界面字体风格的一种方式.md)
...
+ [Linux 命令行[^com]艺术：管道、重定向 & shell 扩展](Linux笔记/cli_art.md)
...
+ [§. Ext文件系统工具](Linux笔记/ext_utils.md)
...
+ [find与xargs：](Linux笔记/find_xargs：.md)
+ [FreeBSD 笔记](Linux笔记/freebsd.md)
...
+ [git笔记](Linux笔记/git.md)
+ [grub 笔记](Linux笔记/grub.md)
+ [iptables：Linux 服务器的包请求过滤](Linux笔记/iptables.md)
+ [font-config](Linux笔记/linux.md)
+ [Linux和Unix](Linux笔记/linux_unix.md)
+ [low_interface](Linux笔记/low_interface.md)
+ [网络的手动配置](Linux笔记/network_manal.md)
...
+ [sed：流编辑器](Linux笔记/sed.md)
+ [Linux Shell[^shell]笔记](Linux笔记/shell.md)
+ [Linux Shell脚本学习笔记](Linux笔记/shell_script.md)
+ [交换 Caps Lock & 左 Ctrl 键](Linux笔记/swap_caps_ctrl.md)
+ [systemd 笔记](Linux笔记/systemd.md)
+ [tar：Linux/Unix 归档工具](Linux笔记/tar.md)
...
+ [util-linux：Linux工具](Linux笔记/util_linux.md)
+ [邦飞科技笔试题资料](tmp/bunfly_2.md)
+ [tmp](tmp/tmp.md)
+ [定期备份文件](tmp/定期备份文件.md)
+ [未掌握的知识](tmp/未掌握的知识.md)
+ [分区切换工具：bootice](windows笔记/bootice.md)
+ [Firefox：一个免费的高自定义(扩展很多)浏览器的扩展小配置](windows笔记/firefox.md)
+ [Applications](windows笔记/ProgramFiles.md)
+ [注册表笔记](windows笔记/regedit.md)
+ [Windows 8.1 启用 .NET Framework 组件[^.net][^method]](windows笔记/windows8.1启用.NET3.0和4.0组件.md)
+ [Windows 笔记：](windows笔记/windows8.md)
+ [windows控制台命令[^desc]笔记 :) :(](windows笔记/windows_cmd.md)
