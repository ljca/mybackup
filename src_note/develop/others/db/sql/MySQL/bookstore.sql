...
INSERT INTO `authors` VALUES (1,'Greene Graham','The United Kindom'),(2,' Yang DongQin','China'),(3,'Loney.K Bryla.B',NULL),(4,'Robert Sedgewick Kevin Wayne',NULL);
...
CREATE TABLE `books` (
  ...
  `description` text,
  `genre` enum('novel','poetry','drema') DEFAULT 'novel',
...
-- Dump completed on 2016-02-23 22:28:30
